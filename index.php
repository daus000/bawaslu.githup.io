            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-lg-block bg-warning shadow-lg p-5
                            text-center">
                                <img src="asset/img/logo1.png" width="200">
                                <h1 class="text-dark"> <BR>BAWASLU
                                    <br> Kabupaten Kediri
                                </h1>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="forgot-password.html">By. Bawaslu Kediri | 2021 - <?= date('Y') ?></a>
                                    </div>
